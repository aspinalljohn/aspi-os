...
- One of those links points to the note's **domain hub** → `[[venture-one hub]]`, `[[venture-two hub]]`, `[[venture-three hub]]`, `[[reading hub]]`, `[[projects hub]]`, `[[me hub]]`, `[[resources hub]]`, `[[vault operations hub]]` → so the note is reachable from the map of content.

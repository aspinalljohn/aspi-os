...
**Primitive:** extract a portable, reusable prompt blueprint from any source → save to `08 potential skills/`.
...
5. Writes to `08 potential skills/<kebab-case-name>.md` and cross-links back to the source.
